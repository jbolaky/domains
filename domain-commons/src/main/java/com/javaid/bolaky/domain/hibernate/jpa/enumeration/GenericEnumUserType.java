package com.javaid.bolaky.domain.hibernate.jpa.enumeration;
...
public class GenericEnumUserType implements UserType, ParameterizedType {
	...
	private static final String DEFAULT_VALUE_OF_METHOD_NAME = "convertCode";
	...
	public void setParameterValues(Properties parameters) {
		String enumClassName = parameters.getProperty("type");
		try {
		...
		try {
			identifierMethod = enumClass.getMethod(
					DEFAULT_IDENTIFIER_METHOD_NAME, new Class[0]);
		...
		try {
			valueOfMethod = enumClass.getMethod(DEFAULT_VALUE_OF_METHOD_NAME,
